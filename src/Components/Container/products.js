...
const Button = (props) => {
    const [color, setColors] = React.useState("#333");
    ...
    return (
        ...
        <div className="card w-100 card-product mt-3 shadow">
            <div className="d-flex justify-content-between mt-2 ml-2 mr-2">
                ...
                <div><a className="icons" onClick={()=>handleClickButton(props.id)}><MdFavorite size={26} color={color}></MdFavorite></a></div>
            </div>
            <Link to={`/Preview`}>
            <div className="row justify-content-center mx-auto">
                <img src={props.image} className="card-img-top card-img"></img>
